...
const THEME_MAP: Record<string, {
  ...
  "python programming": {
    ...
    btnGhost: "text-slate-655 hover:text-[#3776AB] font-mono text-xs hover:bg-slate-50 border border-slate-205 rounded px-3 py-1.5 transition-all bg-white shadow-sm inline-flex items-center",
...
export default function ModulesPage() {
  ...
  const themeKey = isUiProgramming 
    ...
    : (isStartupEngineering 
      ...
      : (isDigitalBusiness 
        ? "digital business" 
        : (isPythonProgramming ? "python programming" : "")));
