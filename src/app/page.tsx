    ...
    <div className="flex flex-col min-h-screen">
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-3xl mx-auto text-center space-y-8">
            ...
            <p className="text-xl text-primary-foreground/90 max-w-2xl mx-auto font-medium">
              An interactive educational experience featuring structured learning modules and hands-on virtual simulations.
            </p>
            <HeroButtons />
          </div>
        </div>
      ...
      <section className="bg-white border-b border-zinc-200 py-10 relative -mt-6 z-20">
        <div className="container mx-auto px-4">
          <div className="bg-white rounded-xl shadow-xl border border-zinc-100 p-8 grid grid-cols-2 md:grid-cols-4 gap-8 divide-x divide-zinc-100">
            ...
            <div className="flex flex-col items-center text-center px-4">
              <span className="text-4xl font-extrabold text-amber-500 mb-2">100%</span>
              <span className="text-sm text-zinc-500 font-medium uppercase tracking-wider">Engagement</span>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-24 bg-zinc-900 text-white relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 relative z-10 text-center max-w-3xl">
          ...
          <p className="text-xl text-zinc-300 mb-10">Join your peers in the most engaging way to study courses and solve assessments.</p>
          <FooterButtons />
        </div>
      </section>
    </div>
