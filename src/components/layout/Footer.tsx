...
export function Footer() {
  return (
    <footer className="bg-zinc-900 text-zinc-300 pt-10 pb-6 border-t-4 border-primary">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-6">
          ...
          <div className="space-y-3">
            ...
            <div>
              <Link href="/team" className="text-primary hover:underline text-xs font-semibold inline-flex items-center gap-1">
                View Team Description &rarr;
              </Link>
            </div>
          </div>
